(function($) {
    ...
    $(function() {
        if ($("#performaneLine").length) {
            ...
            var salesTopData = {
                labels: ["NED", "ned", "PON", "pon", "UTO", "uto", "SRI", "sri", "ČET", "čet", "PET", "pet", "SUB"],
                datasets: [{
                    label: 'Ova nedelja',
        ...
        if ($("#marketingOverview").length) {
            ...
            var marketingOverviewData = {
                ...
                datasets: [{
                    label: 'Prošla godina',
                    data: [1110, 1220, 1200, 1190, 1220, 1110, 1210, 1110, 1205, 1202, 1201, 1150],
                    ...
                    label: 'Ova godina',
                    data: [1215, 1290, 1210, 1250, 1290, 1230, 1290, 1210, 1280, 1220, 1190, 1300],
        ...
        if ($("#marketingOverview-dark").length) {
            ...
            var marketingOverviewDataDark = {
                ...
                datasets: [{
                    label: 'Prošla godina',
                    data: [1110, 1220, 1200, 2190, 1220, 1110, 2210, 2110, 2205, 2202, 1201, 1150],
                    backgroundColor: "#52CDFF",
                    borderColor: [
                        '#52CDFF',
                    ],
                    ...
                    label: 'Ova godina',
                    data: [1215, 1290, 2210, 1250, 1290, 1230, 2290, 1210, 1280, 1220, 2190, 1300],
                    backgroundColor: "#1F3BB3",
                    borderColor: [
                        '#1F3BB3',
                    ],
